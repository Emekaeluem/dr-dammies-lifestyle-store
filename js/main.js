...
(function () {
    ...
    const containerWidth = container.offsetWidth || container.parentElement.offsetWidth || window.innerWidth * 0.5;
    const containerHeight = container.offsetHeight || 620;
    ...
    const NODES = [
        ...
        { pos: [-1.2,  0.6,  1.3], label: 'Heart',         tip: 'Heart Health'            },
    ...
    window.addEventListener('resize', () => {
        const w = container.offsetWidth || container.parentElement.offsetWidth || window.innerWidth * 0.5;
